...
from project1.utils import load_all_data, preprocess_data
...
st.set_page_config(page_title="Player Market Value Estimator - Project 1", layout="wide")
st.title("⚽ Project 1: Player Market Value Estimator")

page = st.sidebar.radio("Navigation", ["About", "EDA", "Train Model", "Predict Player Value"], key="main_nav")
...
if page == "Train Model":
    ...
    if st.button("Train Model Now"):
        with st.spinner("Training models. This may take a moment..."):
            best_model_name, rmse = train_model_project1()
...
# === ABOUT TAB ===
    ...
    st.markdown("""
**Player Market Value Estimator – Project 1** is part of Álvaro Salvador’s Master's Thesis in Computer Science.

**Objective:** Estimate the market value of football players using:
- Random Forest
- XGBoost
- SVR

The best model is selected based on RMSE and saved for future use.

**Features:**
- Player value prediction
- Real value comparison (2020–21)
- Exploratory analysis
- Model retraining from the interface

**Technologies:**
- Python, Scikit-learn, XGBoost
- Streamlit, Pandas, FBRef + Transfermarkt data
